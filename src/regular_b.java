...
public class regular_b {
    public static void main(String[] args) {
        ...
        //поиск 4 чисел которые встрет€с€ первыми и заменить их на подстроку
        ...
        String text3 = "ѕривет јнна ты из –осси€ ?  ";
        System.out.println(text3.replaceAll("[–о]осси[и€]"," анады")); //замена текста во всем тексте
